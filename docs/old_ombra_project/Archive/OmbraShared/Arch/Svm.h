...
struct VmcbControlArea
{
    ...
    unsigned long long GMETEnable : 1; // Guest Mode Execute Trap
    unsigned long long GuestTscScaling : 1; // Guest TSC scaling
    unsigned long long Reserved2 : 59; // Should be zero
...
struct Vmcb
{
    ...
    // Accessor methods for PayLoad compatibility
    __forceinline unsigned long long& Cr3() { return StateSaveArea.Cr3; }
    __forceinline unsigned long long& Rax() { return StateSaveArea.Rax; }
    __forceinline unsigned long long& Rsp() { return StateSaveArea.Rsp; }
    __forceinline unsigned long long& Rip() { return StateSaveArea.Rip; }
    __forceinline unsigned long long& Rflags() { return StateSaveArea.Rflags; }
    __forceinline unsigned long long& NestedPageTableCr3() { return ControlArea.NestedPageTableCr3; }
};
