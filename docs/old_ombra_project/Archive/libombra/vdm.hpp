...
public:
	...
	{
		auto status = ombra::read_virt((ULONG64)Destination, Source, NumberOfBytes, cr3 != ~0ull ? cr3 : _gameCr3);
	...
	{
		auto status = ombra::write_virt(Destination, (ULONG64)Source, NumberOfBytes, cr3 != ~0ull ? cr3 : _gameCr3);
		return status == VMX_ROOT_ERROR::SUCCESS;
	}
