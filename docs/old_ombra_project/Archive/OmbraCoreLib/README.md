...
# How to use
- Add OmbraCoreLib.lib in "Additional Dependencies" in Librarian section for your kernel driver.
- Add your library directory
- Add your include directory for OmbraCoreLib header files in C/C++ -> "Additional Include Directories"
...
## OmbraCoreLib-v (formerly SKLib-v)
This is the real deal I suppose. It leverages OmbraCoreLib utilities to support the usual hv thing everyone does with cheats, aka system subversion.
