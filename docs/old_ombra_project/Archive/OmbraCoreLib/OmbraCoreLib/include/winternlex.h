...
#define DEFINE_OMBRA_GUID(name, l, w1, w2, b1, b2, b3, b4, b5, b6, b7, b8) \
        constexpr GUID name \
...
typedef struct _RTL_USER_PROCESS_PARAMETERS_OMBRA {
	BYTE Reserved1[16];
	PVOID Reserved2[10];
	UNICODE_STRING ImagePathName;
	UNICODE_STRING CommandLine;
} RTL_USER_PROCESS_PARAMETERS_OMBRA, * PRTL_USER_PROCESS_PARAMETERS_OMBRA;

typedef struct _PEB_OMBRA {
	...
	PRTL_USER_PROCESS_PARAMETERS_OMBRA ProcessParameters;
	PVOID SubSystemData;
	PVOID ProcessHeap;
	PVOID FastPebLock;
