...
// =============================================================================
// NOTE: EPT Page Splitting Functions
// =============================================================================
//
// EptSplit1GbTo2Mb() and EptSplit2MbTo4Kb() are defined in ept.c (not here).
// These functions are declared in ept.h and accessible via #include "ept.h".
//
// The ept.c implementations properly track split tables in SplitPdTables[],
// which is required for correct operation of EptSplit2MbTo4Kb().
//
// DO NOT add duplicate implementations here - it causes linker errors.
// =============================================================================
